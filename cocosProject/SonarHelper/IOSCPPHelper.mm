...
void IOSCPPHelper::preloadChartboostFullScreenAd( )
{
    [[IOSHelper instance] preloadChartboostFullScreenAd];
}

bool IOSCPPHelper::isChartboostFullscreenAdReady() {
    return [[IOSHelper instance] isChartboostFullscreenAdReady];
}
