...
// preload a Chartboost interstitial ad
-( void )preloadChartboostFullScreenAd
{
    [Chartboost cacheInterstitial:CBLocationDefault];
}

-( BOOL ) isChartboostFullscreenAdReady 
{
    return [Chartboost hasInterstitial:CBLocationDefault] == YES;
}
