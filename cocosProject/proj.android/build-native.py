...
def check_environment_variables():
    ...
    try:
        ...
        sys.exit(1)
    try:
        COCOS_ROOT = os.environ['COCOS_ROOT']
    except Exception:
        COCOS_ROOT = "../cocos2d"
...
def get_num_of_cpu():
    ...
    try:
        ...
        print "Can't know cpu info, use default 1 cpu"
        return 1
...
def do_build(app_android_root, ndk_build_param, android_platform, build_mode):
...
def build(ndk_build_param, android_platform, build_mode):
    ...
    do_build(app_android_root, ndk_build_param, android_platform, build_mode)
...
if __name__ == '__main__':
    ...
    help='parameter for android-update.Without the parameter,the script just build dynamic library for project. Valid android-platform are:[10|11|..|22]')
    parser.add_option("-b", "--build", dest="build_mode", 
    help='the build mode for java project,debug[default] or release. To get more information, please refer to http://developer.android.com/tools/building/building-cmdline.html')
